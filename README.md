...
### The Bottom
This part took me a long time to make because i had to keep chaning the measurements to fit the gears better. Its basically a rectangular box with a tiny portion of the top covered. This is just to not make the opening too big. <img width="1079" height="708" alt="Screenshot 2025-12-12 203929" src="https://github.com/user-attachments/assets/da42c89c-c4bb-4367-897c-15e292624e84" /> It has a notch and a hole on the side to fit the two gears and the crank from the outside too. 
### The Top
This is a straightforward part. Its just a slab of plastic with a tiny hole which would be used to connect it to the gear mechanism later. It also has my name extruded just because it looks cool! (i wanted to show off at school) The top can also be modified to accept a piece of acrylic sheet so that you can see what you have on the inside but i didnt really like it so i left it like this.<img width="1034" height="600" alt="Screenshot 2025-12-12 203952" src="https://github.com/user-attachments/assets/71d357ca-886c-4e43-850b-5ff3b8e448d1" />
...
## Extra Parts
The only extra part needed to complete the build is a door hinge. I didnt add holes because it varies depending on the hinge you buy. Its easy enough to add the holes yourself after printing. Other than that maybe some hot glue or  tape to hold the components down while fixing it. 
## BOM
- 3D printed Top,Bottom,Gears and Misc
- One Door Hinge
